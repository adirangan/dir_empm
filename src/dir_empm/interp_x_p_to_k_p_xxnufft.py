...
def interp_x_p_to_k_p_xxnufft(
    ...
    S_k_p_wk_ = xxnufft2d3(n_t_sum,x_c_0_tx_*eta,x_c_1_tx_*eta,S_x_p_tx_*weight_2d_x_p_tx_,-1,1e-12,n_w_sum,2*pi*k_c_0_wk_/eta,2*pi*k_c_1_wk_/eta,finufft_opts);
